<%@ page import="com.ycy.util.CookieUtil" %><%--
...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=1">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=2">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=3">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=4">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=5">
    ...
    <div class="col-md-2">
        <a href="ServletProductInfo?id=6">
...
<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
    ...
    <div style="overflow: hidden;">
        ...
        <div>
            <h5><a href="ServletClearHistory">清除浏览记录</a></h5>
        </div>
